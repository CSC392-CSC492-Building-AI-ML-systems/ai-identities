  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-lg p-8 rounded-xl shadow-lg bg-[#2D2A5A]">
        ...
        />
        {errors.username && (
          <p className="text-sm mb-4 text-[#FF6B6B]">{errors.username.message}</p>
        )}
        ...
        />
        {errors.email && (
          <p className="text-sm mb-4 text-[#FF6B6B]">{errors.email.message}</p>
        )}
        ...
        />
        {errors.password && (
          <p className="text-sm mb-4 text-[#FF6B6B]">{errors.password.message}</p>
        )}
